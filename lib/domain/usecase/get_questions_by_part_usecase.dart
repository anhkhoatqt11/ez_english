...
class GetQuestionsByPartUseCase
    extends BaseUseCase<GetQuestionsByPartObject, List<Question>> {
  ...
  Future<Either<Failure, List<Question>>> execute(
      GetQuestionsByPartObject input) {
    return questionRepository.getQuestionByPart(
        input.part, input.skill, input.limit);
  }
}

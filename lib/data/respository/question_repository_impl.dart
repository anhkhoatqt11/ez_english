...
class QuestionRepositoryImpl implements QuestionRepository {
  ...
  @override
  Future<Either<Failure, List<Question>>> getQuestionByPart(int part, String skill) async {
    try {
      if(await networkInfo.isConnected) {
        List<Question> questionList = (await questionRemoteDataSouce.getQuestionByPart(GetQuestionByPartRequest(part, skill))).map((e) => e.toQuestion()).toList();

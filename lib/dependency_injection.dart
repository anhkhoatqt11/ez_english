...
import 'data/respository/history_repository_impl.dart';
...
Future<void> initAppModule() async {
  ...
  _instance.registerLazySingleton<HistoryRemoteDataSource>(
    () => HistoryRemoteDataSourceImpl(supabase),
  );
  initRepository();
...
initRepository() {
  ...
  if (!_instance.isRegistered<HistoryRepository>()) {
    _instance.registerLazySingleton<HistoryRepository>(
      () => HistoryRepositoryImpl(_instance(), _instance()),
    );
  }
}
...
initTestInfoModule() {
  ...
  if (!_instance.isRegistered<SaveInHistoryUseCase>()) {
    _instance.registerLazySingleton<SaveInHistoryUseCase>(
      () => SaveInHistoryUseCase(_instance()),
    );
  }
